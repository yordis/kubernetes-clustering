...
Vagrant.configure('2') do |config|
  ...
  config.vm.define :master_node, primary: true do |master_node|
    ...
    master_node.vm.network :forwarded_port, guest: 80, host: 9250, host_ip: '127.0.0.1'
  ...
  config.vm.define :worker_node_1 do |worker_node_1|
    ...
    worker_node_1.vm.network :forwarded_port, guest: 80, host: 9251, host_ip: '127.0.0.1'
  ...
  config.vm.define :worker_node_2 do |worker_node_2|
    ...
    worker_node_2.vm.network :forwarded_port, guest: 80, host: 9252, host_ip: '127.0.0.1'
